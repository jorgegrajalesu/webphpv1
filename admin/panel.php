...
<head>
    ...
    <title>Administración del aplicativo</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" title=" Editar Usuario"
                        href="panel.php?modulo=editarUsuario&idusuario=<?php echo $_SESSION['idusuario'];?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="panel.php?modulo=libros"
                                        class="nav-link <?php echo ($modulo="libros" || $modulo="crearLibro" || $modulo="editarLibro")? " active":" ";?>">
                                        <i class=" far fa-circle nav-icon"></i>
                                        <p>Libros</p>
                                    </a>
                                </li>
